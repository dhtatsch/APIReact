...
import { salvarRepositoriosDoUsuario, deletarRepositoriosDoUsuario } from '../../services/requisicoes/repositorios';
...
export default function InfoRepositorio({ route, navigation }) {
    ...
    async function deletar() {
        ...
        if (resultado === 'sucesso') {
            Alert.alert("Repositório excluído com sucesso!")
            navigation.goBack()
        }
        else {
            Alert.alert("Erro ao excluir o repositório!")
        }
    }
